...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=24&pause=1000&color=5DB2E4&size=35&center=true&vCenter=true&width=1000&lines=Olá,+Mundo!+Meu+nome+é+Alysson;Sou+de+Fortaleza-CEEstudo+Desenvolvimento+de+Sistemas;Seja+Bem-Vindo!+:%29)](https://git.io/typing-svg)

<ul>
  <li>:mortar_board: Análise e Desenvolvimento de Sistemas</li>
  <li>:globe_with_meridians: Desenvolvimento Web</li>
  <li>:computer: Ênfase no Back-end</li>
  <li>:open_book: Conhecimentos em: HTML | CSS | PHP | MySQL | JavaScript </li>
